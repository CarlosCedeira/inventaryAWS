...
type NumericFormValue = string | number;
...
export const validateProductForm = (
  form: ProductForm,
  { allowZeroQuantity = false }: ProductValidationOptions = {},
): string | null => {
...
function validateEditableStockQuantity(
  value: NumericFormValue | null | undefined,
): string | null {
